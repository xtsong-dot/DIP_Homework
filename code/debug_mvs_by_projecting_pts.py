...
def default_results_dir(data_dir):
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default=None, help='Directory for projection images (default: results/<scene>/projections)')
    ...
    output_dir = args.output_dir or os.path.join(default_results_dir(dataset_path), "projections")
